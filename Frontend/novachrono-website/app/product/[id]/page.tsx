  ...
  return (
    <div className="container mx-auto px-4 md:px-6 py-12 ">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20">
        ...
        {/* Product Info */}
        <div className="bg-black p-10 rounded-lg flex flex-col justify-between">
          <motion.div
            initial={{ opacity: 0, x: 20 }}
            animate={{ opacity: 1, x: 0 }}
            className="space-y-8"
          >
            ...
            <div className="prose prose-invert text-gray-400">
              <p>
                {product.description ||
                  "Experience the pinnacle of craftsmanship with this exquisite timepiece. Designed for those who appreciate the finer things in life, it combines precision engineering with timeless aesthetics."}
              </p>
            </div>
